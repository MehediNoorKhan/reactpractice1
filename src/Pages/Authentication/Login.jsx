  ...
  return (
    <section className='max-w-[384px]'>
        ...
        <fieldset className="fieldset">
          ...
          <button className="bg-[#CAEB66] font-medium py-2 rounded-lg cursor-pointer">Login</button>
        </fieldset>
        <div className='flex flex-col justify-center'>
            <p>Don't have any account? <a className="link link-hover text-[#8FA748]">Register</a></p>
